...
#                Clone, Move by, and Center to
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                center, defaults, fill color
#
#     f. What does a RoseWindow RENDER method do?
#            Draws all of the objects attached to the window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            Gives user ability to view animation for as long as they like, otherwise it would close once it is finished running.
#
